<p align="center">
  <img src="./etc/asset/tamagochi-logo-min.png" alt="Tamagochi Logo" width="100"/>
</p>

<p align="center">
  <strong>Honestly, a rather simple wrapper around the amazing <a src="https://github.com/go-chi/chi">go-chi</a></strong>
</p>
...
```
go install github.com/flazhgrowth/fg-tamagochi/cmd/conjurer@v1.1.1
```
...
The base command is `conjure`, which practically does nothing. Like, `conjure` sounds cool though, so we put it in there before anything else.
